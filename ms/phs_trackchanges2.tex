...
\section{Figures}
  ...
  \end{figure}
    ...
    \begin{figure}[h]
     ...
     (a/b) SMS
     (c/d) PHS.
     Arrows indicate start of TFE. Supplementary Figure \ref{supp:sm2} plots 7 other soil depths. In the SMS configuration, soil moisture can tend to `stick' at water content of 0.1 during the dry season, which corresponds to $\psi_{\text{soil}}$=-2.5MPa and is the value of the SMS soil wilting parameter, $\psi_c$. }
     \label{fig:sm2}
  \end{figure}
