...
\label{sect:ttfe}
PHS performs better than SMS at reproducing transpiration observations under TFE (Figure \ref{fig:t}b,d), though R$^2$ and RMSE under TFE were degraded relative to the ambient simulations in both the SMS and PHS configurations.
